...
function anonymous(jQuery, $data, $i) {
    ...
    with ($.extend(true, {}, _, $data)) {
        try {
            ...
            T.push("\">");
            pushT(name, this);
            T.push("</a> has been to these cities.\n    </p>\n");
        }
        catch (e) {
            if ($.tmpl.debug) {
                T.push(" " + e + " ");
...
function anonymous(jQuery, $data, $i) {
    ...
    with ($.extend(true, {}, _, $data)) {
        try {
            T.push("\n<div id=\"traveling\">\n    <h2>Traveling</h2>\n    <p>Traveling is nice. Where have you been?</p>\n</div>\n");
        }
        catch (e) {
            if ($.tmpl.debug) {
                T.push(" " + e + " ");
